...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relic.series_num'
        db.add_column('relic_relic', 'series_num',
                      self.gf('django.db.models.fields.IntegerField')(default=None, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Relic.series_num'
        db.delete_column('relic_relic', 'series_num')
    ...
    models = {
        'relic.relic': {
            ...
            'series_num': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
