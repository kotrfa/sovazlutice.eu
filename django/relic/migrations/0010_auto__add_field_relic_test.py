...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('relic_relic', 'test',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True, db_index=True, default=1),
                      keep_default=False)
    ...
    models = {
        'relic.relic': {
            ...
            'test': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True', 'db_index': 'True'}),
