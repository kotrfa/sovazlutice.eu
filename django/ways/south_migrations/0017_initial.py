...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ways_way', (
            ...
            ('the_path', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('length', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
            ('interest1_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('interest1_body', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('interest2_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('interest2_body', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('interest3_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('interest3_body', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('map_of_way', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
            ('pic1', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
            ('pic2', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
            ('pic3', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
            ('pic4', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
            ('pic5', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
            ('pic6', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
            ('pic7', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
            ('pic8', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
        ))
